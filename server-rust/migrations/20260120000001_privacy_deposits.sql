...
CREATE INDEX idx_deposit_sessions_user ON deposit_sessions(user_id);
CREATE INDEX idx_deposit_sessions_wallet ON deposit_sessions(wallet_address);
CREATE INDEX idx_deposit_sessions_status ON deposit_sessions(status);
CREATE INDEX idx_deposit_sessions_session ON deposit_sessions(session_id);
...
CREATE INDEX idx_webhook_events_session ON deposit_webhook_events(deposit_session_id);
CREATE INDEX idx_webhook_events_wallet ON deposit_webhook_events(wallet_address);
...
CREATE INDEX idx_privacy_notes_user ON privacy_notes(user_id);
CREATE INDEX idx_privacy_notes_status ON privacy_notes(status);
CREATE INDEX idx_privacy_notes_commitment ON privacy_notes(commitment_hash);
CREATE INDEX idx_privacy_notes_withdrawal_ready ON privacy_notes(status, deposited_at)

...
import { useState as M, useRef as D, useEffect as C, useCallback as P, useMemo as L, Suspense as z, useContext as H, createContext as F, lazy as w } from "react";
...
function ve({
  ...
  return /* @__PURE__ */ e(O.Provider, { value: j, children: /* @__PURE__ */ e(J.Provider, { value: B, children: /* @__PURE__ */ n("div", { className: `cedros-admin cedros-admin-shell ${x || ""}`, children: [
    ...
    /* @__PURE__ */ e("main", { className: "cedros-admin-shell__main", children: N ? /* @__PURE__ */ e(z, { fallback: /* @__PURE__ */ e(Z, {}), children: /* @__PURE__ */ e(
      "div",
      {
...
}, ee = w(() => import("./UsersSection-Ct_E-MBF.js")), re = w(() => import("./TeamSection-C_eODdLU.js")), se = w(() => import("./DepositsSection-Bb4ISzvE.js")), ie = w(() => import("./WithdrawalsSection-BN-FjTEV.js")), ne = w(() => import("./AuthenticationSettings-DrHqtD7p.js")), oe = w(() => import("./EmbeddedWalletSettings-B-083zu6.js")), te = w(() => import("./EmailSettings-XETM8FdS.js")), ae = w(() => import("./WebhookSettings-BhIwucKb.js")), le = w(() => import("./CreditSystemSettings-BTqZFn4K.js")), de = w(() => import("./ServerSettings-DBpbRihl.js")), ce = {

...
import { L as w, E as I } from "./ErrorMessage-59nRkszi.js";
import { u as M, A as b, S as A } from "./AutosaveStatus-DOyrYcZE.js";
const j = {
...
function F({ className: n }) {
  ...
  const m = (c("email_provider") || "custom") === "custom", _ = c("email_smtp_host"), v = !m || _ != null && _ !== "", g = P(() => {

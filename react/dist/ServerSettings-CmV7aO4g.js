...
import { L as A, E as x } from "./ErrorMessage-59nRkszi.js";
import { u as E, A as L, S as T } from "./AutosaveStatus-Bg31Q4YA.js";
const $ = [
  {
    id: "integrations",
    label: "Integrations",
...
function O({ className: o }) {
  ...
  const i = t.find((e) => e.id === r), y = v(() => {
    if (!i) return [];
    const e = i.categories ?? ["server"], f = [];
    for (const n of e) {
      const l = c[n] ?? [];
      f.push(...l);
    }
    return f.filter((n) => i.keys.includes(n.key)).sort((n, l) => i.keys.indexOf(n.key) - i.keys.indexOf(l.key));
  }, [c, i]);
  return S && Object.keys(c).length === 0 ? /* @__PURE__ */ a("div", { className: `cedros-system-settings cedros-system-settings-loading ${o ?? ""}`, children: [
    ...
    /* @__PURE__ */ s("div", { className: "cedros-admin-tab-content", role: "tabpanel", children: y.length === 0 ? /* @__PURE__ */ s("div", { className: "cedros-system-settings-empty", children: /* @__PURE__ */ a("p", { children: [
      "No settings found for ",
      i?.label ?? "this section",
      "."
    ] }) }) : /* @__PURE__ */ s(T, { settings: y, edits: p, onChange: k }) })
  ] });
}
export {
  O as S

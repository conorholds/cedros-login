...
function ae() {
  const { config: e, _internal: t } = ee(), [b, s] = v(!1), [D, l] = v(null), f = Q(
    () => new te({
      baseUrl: e.serverUrl,
...
function R({
  ...
  if (M(() => {
    ...
    r ? k.current = !0 : k.current && (k.current = !1, g && !u && w && !m ? P(!0) : g && !u && h(!1));
  }, [r, g, u, w, m]), f && z.length === 0)
    return null;
  const j = async () => {
    l || i || m || (u && p && y ? (h(!0), await N()) : z.length === 1 && !w ? ($(z[0].adapter.name), h(!0), P(!0)) : (w && a.select(null), C(!0), h(!0)));
  }, O = {
    sm: "cedros-button-sm",
    md: "cedros-button-md",
    lg: "cedros-button-lg"
  ...
  return M(() => {
    ...
    {
      type: "button",
      className: `cedros-button ${G[s]} ${O[D]} ${b}`,
      onClick: j,
      disabled: l || A,

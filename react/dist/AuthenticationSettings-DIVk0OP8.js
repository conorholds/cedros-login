...
import { useRef as M, useState as y, useCallback as k, useEffect as $, useMemo as O } from "react";
import { L } from "./LoadingSpinner-6vml-zwr.js";
import { E as D } from "./ErrorMessage-CcEK0pYO.js";
import { u as T, A as j, S as F } from "./AutosaveStatus-f-jw25Ay.js";
import { u as z } from "./useCedrosLogin-CFfID-0i.js";
import { u as B } from "./useOrgs-C90KT9KP.js";
function U() {
  const { config: t, _internal: m } = z(), l = t.serverUrl, g = M(m?.getAccessToken ?? (() => null));
  g.current = m?.getAccessToken ?? (() => null);
  const [v, w] = y([]), [f, N] = y(0), [C, p] = y(!1), [_, a] = y(null), n = k(() => {
    const b = g.current();
    return {
    ...
    async (b, c = 50, d = 0) => {
      ...
      try {
        ...
        return w(S.providers), N(S.total), S;
      } catch (u) {
    ...
    async (b, c) => {
      ...
      try {
        ...
        return w((r) => r.map((S) => S.id === b ? u : S)), u;
      } catch (d) {
...
function H({ className: t }) {
  const {
    ...
    deleteProvider: N,
    toggleProvider: C
  } = U(), { activeOrg: p } = B(), [_, a] = y("list"), [n, o] = y(null), [i, h] = y(null);
  $(() => {
    v(p?.id);
  }, [v, p?.id]);
  const x = () => {
    ...
    h(null);
    try {
      _ === "add" ? await w(r) : n && await f(n.id, r), a("list"), o(null);
    } catch (S) {
      h(S instanceof Error ? S.message : "Failed to save provider");
    }
  };
  return l && m.length === 0 ? /* @__PURE__ */ s("div", { className: `cedros-system-settings cedros-system-settings-loading ${t ?? ""}`, children: [
  ...
  ] }) : _ === "add" || _ === "edit" ? /* @__PURE__ */ e("div", { className: `cedros-system-settings ${t ?? ""}`, children: /* @__PURE__ */ e(
    W,
    {
      provider: n,
      orgId: p?.id,
    ...
    g && /* @__PURE__ */ e(D, { error: g.message }),
...
function K({ provider: t, onEdit: m, onDelete: l, onToggle: g }) {
  return /* @__PURE__ */ s(
    "div",
    {
...
function W({
  ...
  const f = !!t, [N, C] = y(t?.name ?? ""), [p, _] = y(t?.issuerUrl ?? ""), [a, n] = y(t?.clientId ?? ""), [o, i] = y(""), [h, x] = y(t?.emailDomain ?? ""), [E, b] = y(t?.allowRegistration ?? !0), [c, d] = y(t?.enabled ?? !0), u = k(
    (r) => {
  ...
  return /* @__PURE__ */ s("form", { className: "cedros-sso-provider-form", onSubmit: u, children: [
    ...
    /* @__PURE__ */ s("div", { className: "cedros-form-actions", children: [
      ...
      /* @__PURE__ */ e("button", { type: "submit", className: "cedros-btn cedros-btn-primary", disabled: g, children: g ? "Saving..." : f ? "Save Changes" : "Add Provider" })
    ] })
  ] });
}
function q() {
...
function P(t, m) {
  for (const l of Object.values(t)) {
    const g = l.find((v) => v.key === m);
    if (g) return g.value === "true";
  }
  return !0;
}
function Y(t) {
  for (const m of Object.values(t)) {
    const l = m.find((g) => g.key === "ui_social_button_order");
    if (l && l.value) return l.value.split(",").map((g) => g.trim());
  }
  return Q;
}
function Z() {
...
function ee({ settings: t, handleChange: m }) {
  const [l, g] = y(() => Y(t)), v = M(null), [w, f] = y(null), N = k(
    (n) => {
      g(n), m("ui_social_button_order", n.join(","));
    },
    [m]
  ), C = k((n) => {
    v.current = n;
        ...
        return /* @__PURE__ */ s(
          "li",
          {
            ...
            style: {
              ...
              border: w === o ? "2px solid var(--cedros-primary, #6366f1)" : "1px solid var(--cedros-border, #e5e7eb)",
...
const I = [
  ...
  { id: "buttonorder", label: "Button Order", categories: [], isCustom: !0 },
  {
    id: "postlogin",
    label: "Post-Login",
    categories: ["postlogin", "postlogin.welcome", "postlogin.complete"],
    keys: ["postlogin_redirect_url", "postlogin_welcome_enabled", "postlogin_welcome_route", "postlogin_complete_enabled"]
  }
];
function le({ className: t }) {
  ...
  return g && Object.keys(m).length === 0 ? /* @__PURE__ */ s("div", { className: `cedros-system-settings cedros-system-settings-loading ${t ?? ""}`, children: [
    /* @__PURE__ */ e(L, {}),
    ...
    /* @__PURE__ */ s("div", { className: "cedros-settings-page-header", children: [
      ...
      /* @__PURE__ */ e(j, { status: v, error: w })
    ] }),
    /* @__PURE__ */ e("div", { className: "cedros-admin-tabs cedros-admin-tabs--line", children: I.map((i) => /* @__PURE__ */ e(
      "button",
      {
        type: "button",
        className: `cedros-admin-tab ${p === i.id ? "cedros-admin-tab-active" : ""}`,
        onClick: () => _(i.id),
        "aria-selected": p === i.id,
        role: "tab",
        children: i.label
      },
      i.id

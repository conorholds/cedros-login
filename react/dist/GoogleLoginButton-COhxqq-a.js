...
import { b as T, A as P, h as O, L as z } from "./ErrorMessage-DObd7075.js";
const U = {
  loading: !1,
  loaded: !1,
  error: null,
...
function j() {
  const { config: o, _internal: i } = T(), [d, t] = R(!1), [s, g] = R(!1), [w, l] = R(null), [h, p] = R(null), a = E(null), m = E(o), b = E(null), c = E(void 0), k = S(
    () => new P({
      baseUrl: o.serverUrl,
  ...
  const _ = f(async (r) => {
    ...
    return t(!0), l(null), new Promise((e, n) => {
      a.current = { resolve: e, reject: n }, b.current?.requestAccessToken();
    });
...
function x({
  ...
  const { signIn: l, isLoading: h, isInitialized: p } = j(), a = async () => {
    try {
      ...
      const k = c instanceof Error ? c : new Error(String(c));
      i?.(k);
    }
  }, m = {
    sm: "cedros-button-sm",

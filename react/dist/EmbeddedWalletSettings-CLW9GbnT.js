...
import { L, E as W } from "./ErrorMessage-59nRkszi.js";
import { u as C, A as M, S as $ } from "./AutosaveStatus-DOyrYcZE.js";
const d = ["wallet_recovery_mode", "wallet_enroll_solana_users"];
function j({ className: n }) {
  const {
    settings: c,
    edits: b,
    isLoading: p,
  ...
  }, u = r("deposit_privacy_enabled") === "true", y = r("wallet_recovery_mode"), o = u && y !== "none", _ = u && !t, S = x(() => {
    if (o)
      return {
        wallet_recovery_mode: "Private deposits require No Recovery mode. Deposits will fail with the current setting."
      };
  }, [o]);
  return p && Object.keys(c).length === 0 ? /* @__PURE__ */ s("div", { className: `cedros-system-settings cedros-system-settings-loading ${n ?? ""}`, children: [
    /* @__PURE__ */ e(L, {}),
    ...
    _ && /* @__PURE__ */ e("div", { className: "cedros-settings-warning-banner", children: "Private deposits are enabled but require the embedded wallet. Enable it above." }),

...
import { useState as T, useEffect as j, useMemo as y, useCallback as A } from "react";
import { L, E as $ } from "./ErrorMessage-59nRkszi.js";
import { u as M, A as B, S as k } from "./AutosaveStatus-DHETHwkf.js";
const w = [
  {
    id: "deposits",
    label: "Deposits",
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        description: "Auto-generated secrets shared between the auth server and the login-sidecar. Copy these into your sidecar deploy secrets.",
...
function q({ className: p }) {
  ...
  ] }) : h ? /* @__PURE__ */ i("div", { className: `cedros-system-settings ${p ?? ""}`, children: /* @__PURE__ */ i($, { error: h.message }) }) : /* @__PURE__ */ a("div", { className: `cedros-system-settings ${p ?? ""}`, children: [
